      ...
      '/chatgpt/': [
        {
          ...
          collapsed: false,
          items: [
            { text: 'ChatGPT官网完全指南：国内访问、注册、中文版使用教程（2026年05月最新）', link: '/chatgpt/chatgpt-guanwang-guonei-zhuce-shiyong-jiaocheng-2026-05' },
            ...
            { text: 'ChatGPT官网网址登录入口｜2026年5月国内怎么用ChatGPT', link: '/chatgpt/chatgpt-guanwang-wangzhi-denglu-rukou-guonei-zhinan-2026' },
            { text: 'ChatGPT 中文版：国内免费指南（支持 GPT-5、GPT-4o、o3 和 Claude 4.5 Sonnet、Gemini 3 Pro）【2026年更新】', link: '/chatgpt/chatgpt_chinese_mirror_guide_2026' },
            { text: 'Anthropic Claude官网中文版：国内最全Claude opus使用指南【4月最新更新】', link: '/chatgpt/claude_opus_chinese_guide_april_update_with_mirrors_corrected' },
            { text: 'GPT-5.5 已经悄然上线，国内用户怎么快速体验 ChatGPT？', link: '/chatgpt/chatgpt_chinese_gpt55_zhihu_article' },
            { text: 'GPT Image-2 是什么？OpenAI Chatgpt最新 AI 生图模型介绍、使用方法与对比', link: '/chatgpt/gpt-image-2-seo-article' },
            { text: 'OpenAI ChatGPT 国内中文版使用指南，包含 GPT-5、GPT-5 系列【2026年5月最新更新】', link: '/chatgpt/chatgpt_guide_cn20260423' },
            ...
            { text: '新手如何使用ChatGPT总结新闻发到微信公众号教程，含chatgpt最新官方入口（2026年5月最新）', link: '/chatgpt/chatgpt-news-summary-wechat-guide' },
            ...
            { text: 'Claude 4.6国内怎么用？2026年5月中文版使用教程（免翻墙｜附ChatGPT对比）', link: '/chatgpt/claude-4-6-guonei-zenme-yong-jiaocheng-april-2026' },
            { text: 'OpenAI ChatGPT 国内中文版使用指南（2026年5月最新）含GPT-5.4、GPT-5.2、GPT-5完整教程', link: '/chatgpt/openai-chatgpt-guo-nei-zhong-wen-ban-shi-yong-zhi-nan-2026-gpt-5-4-zui-xin-wan-zheng-jiao-cheng' },
            { text: 'ChatGPT 中文版国内使用全攻略：支持 GPT-5.4 Thinking 与 GPT-5.3 Instant【2026年5月最新】', link: '/chatgpt/ChatGPT_CN_Usage_Guide_2026' },
            ...
            { text: 'ChatGPT Plus值得买吗？2026年5月GPT-5.4 Plus vs 免费版深度对比（附省钱攻略）', link: '/chatgpt/chatgpt-plus-worth-it-gpt54-comparison-april-2026' },
            { text: 'OpenAI最新动态2026年5月：GPT-6即将发布、GPT Image 2惊艳亮相、Sora被砍', link: '/chatgpt/chatgpt-openai-zuixin-dongtai-gpt6-gpt-image2-2026' },
            { text: 'GPT-6什么时候发布？OpenAI GPT-6最新消息汇总与功能预测（2026年5月）', link: '/chatgpt/gpt-6-zuixin-xiaoxi-fabu-shijian-gongneng-yuce-2026' },
            { text: 'Grok是什么？一文看懂xAI Grok怎么用、和ChatGPT有什么区别（2026年5月实测）', link: '/chatgpt/grok-shi-shenme-zenme-yong-vs-chatgpt-shice-2026' },
            { text: 'DeepSeek vs ChatGPT哪个好？2026年5月国内AI大模型深度对比（GPT-5.4 vs DeepSeek-V3）', link: '/chatgpt/deepseek-vs-chatgpt-duibi-2026-april' },
            { text: 'Grok 4.2中文版国内怎么用？2026年5月最新免翻墙使用教程', link: '/chatgpt/grok-4-2-zhongwen-ban-guonei-jiaocheng-april-2026' },
            { text: 'ChatGPT注册教程2026年5月｜国内手机号注册ChatGPT账号完整指南（免翻墙方案）', link: '/chatgpt/chatgpt-zhuce-jiaocheng-guonei-zhinan-april-2026' },
            { text: 'ChatGPT官网入口在哪？2026年5月国内ChatGPT中文版使用指南（支持GPT-5.4 Thinking）', link: '/chatgpt/chatgpt-guanwang-rukou-zhongwen-ban-shiyong-zhinan-april-2026' },
            { text: 'ChatGPT国内能用吗？2026年5月亲测可用的GPT-5.4中文版平台与完整使用教程', link: '/chatgpt/chatgpt-guonei-neng-yong-ma-gpt54-wanzheng-jiaocheng-april-2026' },
            { text: 'ChatGPT是什么？2026年新手完整入门指南｜一文搞懂ChatGPT怎么用', link: '/chatgpt/chatgpt-xinshourumen-wanzheng-zhinan-april-2026' },
            { text: 'ChatGPT网页版在线使用教程（2026年5月）｜无需下载，打开浏览器直接用', link: '/chatgpt/chatgpt-wangyeban-zaixian-shiyong-jiaocheng-april-2026' },
            { text: 'ChatGPT官网进不去？2026年5月国内打开ChatGPT的全部方法', link: '/chatgpt/chatgpt-guanwang-dabukai-jiejue-fangan-april-2026' },
            { text: 'ChatGPT镜像网站2026年5月实测推荐｜哪个镜像站最稳定、最好用？', link: '/chatgpt/chatgpt-jingxiang-wangzhan-tuijian-shice-april-2026' },
            { text: 'ChatGPT中文版免费入口推荐（2026年5月更新）｜国内免翻墙使用GPT-5.4最全指南', link: '/chatgpt/chatgpt-zhongwen-ban-mianfei-rukou-april-2026' },
            ...
            { text: 'ChatGPT实用场景TOP10：GPT-5.4写论文/写代码/做PPT实操教程，2026年5月国内直连方案', link: '/chatgpt/chatgpt-gpt54-top10-practical-scenarios-april-2026' },
            { text: 'ChatGPT官网入口国内打开方法｜2026年5月GPT-5.4免翻墙使用全攻略', link: '/chatgpt/chatgpt-official-entry-china-no-vpn-gpt54-guide-2026-march.html' },
            ...
            { text: 'ChatGPT 官网中文版国内使用指南（支持GPT-5 & GPT-4o）【2026年5月持续更新】', link: '/chatgpt/chatgpt-official-website.html' },
            ...
            { text: '2026年5月重磅更新！ChatGPT中文版首发支持 GPT-5.3、Gemini 3.1 Pro 与 Claude 4.6', link: '/chatgpt/chatgpt-cn-gpt5-3-gemini-3-1-pro-update-2026.html' },
      ...
      '/guides/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'ChatGPT 官网：GPT-5 国内使用教程【2026年5月更新】', link: '/guides/chatgpt/chatgpt-official-gpt5-usage-2026.html' },
            ...
            { text: 'ChatGPT 官网中文版国内使用指南【2026年5月持续更新】', link: '/guides/chatgpt/chatgpt-official-website.html' },
            ...
            { text: 'GPT 5.2 已上线！国内可用使用指南【2026年5月发布】', link: '/guides/chatgpt/chatgpt-official-guide-2026.html' },
            { text: 'ChatGPT 中文版国内入口与 GPT-5.2 深度使用教程(2026年最新)', link: '/guides/chatgpt/chatgpt-cn-entry-gpt-deep-guide.html' },
            { text: 'ChatGPT官方最新指南！中文版GPT-5.2入口！【2026年5月4日】', link: '/guides/chatgpt/chatgpt-official-gpt5-2-usage-2026.html' },
            ...
            { text: 'GPT-5.2 国内使用全攻略【2026年5月首发】', link: '/guides/chatgpt/gpt-5-2-china-usage-review-guide.html' },
            { text: 'ChatGPT中文版5.2使用指南', link: '/guides/chatgpt/chatgpt-chinese-5.2-guide.html' },
            { text: 'ChatGPT 5.2 最新模型使用指南！(2026年5月更新)', link: '/guides/chatgpt/chatgpt-china-5.2-guide.html' },
            { text: 'ChatGPT 国内使用解决方案：2026年5月最新指南', link: '/guides/chatgpt/chatgpt-domestic-access-solutions-2026.html' },
      ...
      '/blog/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'ChatGPT 中文版免费：国内使用指南【2026年5月更新】', link: '/blog/chatgpt-cn/chatgpt.html' },
    ...
    if (pageData.relativePath !== 'index.md') {
      const articleSchema = {
        ...
        datePublished: fm.date
          ...
          : new Date('2026-05-04').toISOString(),
